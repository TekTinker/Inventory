                ...
                <div class="col-lg-12">
                    <table class="table" id="material_table">
                        ...
                        <tr>
                            ...
                            <th scope="col" style="cursor: pointer">Price/Unit</th>
                            <th scope="col" style="cursor: pointer">Required</th>
                        ...
                        @foreach ($materials as $material)
                            <tr>
                                <td class="font-weight-bold">{{ $material->material_id }}</td>
                                ...
                                <td>&#8377; {{ $material->required * $material->price}}</td>
                            </tr>
